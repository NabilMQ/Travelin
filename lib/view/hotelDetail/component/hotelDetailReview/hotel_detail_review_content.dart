...
class HotelDetailReviewContent extends StatefulWidget {
  const HotelDetailReviewContent({ super.key });

  @override
  State <HotelDetailReviewContent> createState() => _HotelDetailReviewContentState();
}

class _HotelDetailReviewContentState extends State<HotelDetailReviewContent> {
  @override
